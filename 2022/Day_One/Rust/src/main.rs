...
fn main() {
    ...
    let file_name= "C:\\Users\\Chris\\Documents\\CodeProjects\\AdventOfCode\\2022\\Day_One\\puzzle_input_one.txt";
...
fn max_elves_calories(my_file_name: &str, num_max_vals: usize) -> i32 {
    ...
    if num_max_vals < 1 || num_max_vals > elves_calories_vec.len() {
        panic!("Requested number of maximums should be between 1 and the number of elves");
    }
